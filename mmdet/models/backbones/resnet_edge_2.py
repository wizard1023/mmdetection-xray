...
from mmdet.models.backbones.LatentGNN.Edge_Guidance_2 import Edge_Guidance_2

@MODELS.register_module()
class ResNet_Edge_2(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Edge_2, self).__init__(**kwargs)
        self.edge_guidance = Edge_Guidance_2()
