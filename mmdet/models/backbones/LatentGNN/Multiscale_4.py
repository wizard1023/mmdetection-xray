...
class Multiscale_4(nn.Module):
    def __init__(self):
        super(Multiscale_4, self).__init__()
        ...
        self.weight_levels_3 = nn.Conv2d(8 * 3, 3, kernel_size=1, stride=1, padding=0)
        ...
        self.weight_levels_0 =nn.Conv2d(8 * 3, 3, kernel_size=1, stride=1, padding=0)
        ...
        self.conv_2048 = nn.Conv2d(1024, 2048, kernel_size=3, stride=2, padding=1) # /2

        self.weight_hsv_0 = nn.Conv2d(256,  8, kernel_size=1)
        self.weight_hsv_1 = nn.Conv2d(512,  8, kernel_size=1)
        self.weight_hsv_2 = nn.Conv2d(1024, 8, kernel_size=1)
        self.weight_hsv_3 = nn.Conv2d(2048, 8, kernel_size=1)
    ...
    def forward(self,im, feat):
        ...
        levels_3_w_cat = torch.cat((level_2_d_3_w, level_3_w, hsv_level_3_w), 1)
        ...
        levels_2_w_cat = torch.cat((level_3_u_2_w, level_1_d_2_w, level_2_w, hsv_level_2_w), 1)
        ...
        levels_1_w_cat = torch.cat((level_2_u_1_w, level_0_d_1_w, level_1_w, hsv_level_1_w), 1)
        ...
        levels_0_w_cat = torch.cat((level_1_u_0_w, level_0_w, hsv_level_0_w), 1)
