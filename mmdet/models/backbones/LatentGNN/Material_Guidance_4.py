...
class Material_Guidance_4(nn.Module):
    def __init__(self):
        super(Material_Guidance_4, self).__init__()
        ...
        self.conv_0 = Conv(c1=256, c2=128, k=1)
        ...
        self.material_att0 = Material_Attention(in_channels=256)

        self.channel_down = Conv(c1=2048, c2=512, k=1)
        self.channel_down1 = Conv(c1=1024, c2=256, k=1)
        self.channel_down2 = Conv(c1=512, c2=128, k=1)
    ...
    def forward(self, im, feat):
        ...
        feat_hsv_1_upsample = self.up_sample(self.channel_down2(feat_hsv_1))
        hsv_conv_128_downsample = self.down_sample(hsv_conv_128)
        hsv_0 = hsv_conv_128_downsample + feat_hsv_1_upsample
        feat_conv_0 = self.conv_0(feat[0])
        feat_hsv_0 = torch.cat((feat_conv_0, hsv_0), dim=1)
        feat_hsv_0 = self.material_att0(feat_hsv_0)

        return [feat_hsv_0, feat_hsv_1, feat_hsv_2, feat_hsv_3]
...
if __name__=='__main__':
    ...
    model = Material_Guidance_3().to("cuda:0")
    outs = model(img, feat)
