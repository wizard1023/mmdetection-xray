...
class Material_Guidance_3(nn.Module):
    def __init__(self):
        super(Material_Guidance_3, self).__init__()
        ...
        self.conv5 = Conv(c1=1024, c2=512, k=1)
    ...
    def forward(self, im, feat):
        ...
        hsv_conv_512_downsample = self.down_sample(self.down_sample(hsv_conv_512))
        hsv_2 = hsv_conv_512_downsample + feat_hsv_3_upsample
        feat_conv_2 = self.conv5(feat[2])
        feat_hsv_2 = torch.cat((feat_conv_2,hsv_2),dim=1)
        feat_hsv_2 = self.material_att2(feat_hsv_2)

        return [feat[0], feat[1], feat_hsv_2, feat_hsv_3]
