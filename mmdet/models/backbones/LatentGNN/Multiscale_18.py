...
class Multiscale_18(nn.Module):
    def __init__(self):
        super(Multiscale_18, self).__init__()

        # for level_3
        self.dilated_conv_3_1 = nn.Conv2d(256, 2048,kernel_size=3,stride=2,padding=4,dilation=4)
        self.dilated_conv_3_2 = nn.Conv2d(512, 2048, kernel_size=3, stride=2, padding=3, dilation=3)
        ...
        self.dilated_conv_2_2 = nn.Conv2d(256,1024, kernel_size=3, stride=2, padding=3, dilation=3)
