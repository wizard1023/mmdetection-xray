...
from mmdet.models.backbones.LatentGNN.SKNet import SKConv

class Material_Guidance_8_SKNet(nn.Module):
    def __init__(self):
        super(Material_Guidance_8_SKNet, self).__init__()
...
if __name__=='__main__':
    ...
    model = Material_Guidance_8_SKNet().to("cuda:2")
    outs = model(img, feat)
