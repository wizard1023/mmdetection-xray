...
class Edge_Guidance_3(nn.Module):
    def __init__(self):
        super(Edge_Guidance_3, self).__init__()
        # horizontal
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 1, kernel_size=6, stride=2, padding=2,groups=1),
        ...
        self.conv4 = nn.Sequential(
            ...
            nn.Conv2d(512, 1024, kernel_size=1),  # 点卷积
            nn.BatchNorm2d(1024),
        ...
        self.conv5 = nn.Sequential(
            ...
            nn.Conv2d(1024, 2048, kernel_size=1),  # 点卷积
            nn.BatchNorm2d(2048),
...
if __name__ == "__main__":
    ...
    model = Edge_Guidance_3().to("cuda:0")
    outs = model(img,feat)
    # edge_detect = edge_detect.squeeze(0).cpu().numpy()
    # image = np.transpose(edge_detect, (1, 2, 0))
    # cv2.imwrite("/home/xray/LXM/mmdetection/demo/edge_00151.jpg", image)
