...
class Multiscale_17(nn.Module):
    def __init__(self):
        super(Multiscale_17, self).__init__()
        ...
        self.latent_gnn0 = LatentGNNV1(in_channels=256,
                                       latent_dims=[100, 100],
                                       channel_stride=8,
                                       num_kernels=2,
                                       mode='asymmetric',
        ...
        self.latent_gnn3 = LatentGNNV1(in_channels=2048,
                                       latent_dims=[100, 100],
                                       channel_stride=8,
                                       num_kernels=2,
                                       mode='asymmetric',
    ...
    def forward(self,feat):
        ...
        fused_out_3 = self.conv_11_up_3(self.share_fuse(fused_out_3))
        fused_out_3_att = self.latent_gnn3(fused_out_3)+level_3
        ...
        fused_out_2 = self.conv_11_up_2(self.share_fuse(fused_out_2))
        fused_out_2_att = self.latent_gnn2(fused_out_2)+level_2
        ...
        fused_out_1 = self.conv_11_up_1(self.share_fuse(fused_out_1))
        fused_out_1_att = self.latent_gnn1(fused_out_1)+level_1
        ...
        fused_out_0 = self.conv_11_up_0(self.share_fuse(fused_out_0))
        fused_out_0_att = self.latent_gnn0(fused_out_0)+level_0
