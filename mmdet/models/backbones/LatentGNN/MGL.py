...
class ConcatNet(nn.Module):
    def __init__(self, BatchNorm=nn.BatchNorm2d):
        ...
        self.conv1 = nn.Sequential(BasicConv2d(c1, c1, BatchNorm, kernel_size=3, padding=1),
                                   BasicConv2d(c1, c1, BatchNorm, kernel_size=1, padding=0))
        self.conv2 = nn.Sequential(BasicConv2d(c2, c2, BatchNorm, kernel_size=3, padding=1),
                                   BasicConv2d(c2, c2, BatchNorm, kernel_size=1, padding=0))
        self.conv3 = nn.Sequential(BasicConv2d(c3, c2, BatchNorm, kernel_size=3, padding=1),
                                   BasicConv2d(c2, c2, BatchNorm, kernel_size=1, padding=0))
        self.conv4 = nn.Sequential(BasicConv2d(c4, c2, BatchNorm, kernel_size=3, padding=1),
                                   BasicConv2d(c2, c2, BatchNorm, kernel_size=1, padding=0))
