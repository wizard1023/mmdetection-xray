...
class Material_Guidance_8_CBAM(nn.Module):
    def __init__(self):
        super(Material_Guidance_8_CBAM, self).__init__()
        ...
        self.latent_gnn_ch1 = CBAM(gate_channels=256)

        # self.maxpool2 = nn.AdaptiveMaxPool2d(output_size=(160, 100))
        self.latent_gnn_ch2 = CBAM(gate_channels=512)

        # self.maxpool3 = nn.AdaptiveMaxPool2d(output_size=(80, 50))
        self.latent_gnn_ch3 = CBAM(gate_channels=1024)

        # self.maxpool4 = nn.AdaptiveMaxPool2d(output_size=(40, 25))
        self.latent_gnn_ch4 = CBAM(gate_channels=2048)
