...
class Material_Guidance_8_Nonlocal(nn.Module):
    def __init__(self):
        super(Material_Guidance_8_Nonlocal, self).__init__()
        ...
        #self.latent_gnn_ch1 = _NonLocalBlockND(in_channels=256)

        # self.maxpool2 = nn.AdaptiveMaxPool2d(output_size=(160, 100))
        #self.latent_gnn_ch2 = _NonLocalBlockND(in_channels=512)

        # self.maxpool3 = nn.AdaptiveMaxPool2d(output_size=(80, 50))
        self.latent_gnn_ch3 = _NonLocalBlockND(in_channels=1024)

        # self.maxpool4 = nn.AdaptiveMaxPool2d(output_size=(40, 25))
        self.latent_gnn_ch4 = _NonLocalBlockND(in_channels=2048)
...
if __name__=='__main__':
    ...
    model = Material_Guidance_8_CBAM().to("cuda:2")
    outs = model(img, feat)
