...
class Multiscale_11(nn.Module):
    def __init__(self):
        super(Multiscale_11, self).__init__()

        # filter
        self.sa_0 = ChannelAttention(256)
        self.sa_1 = ChannelAttention(512)
        self.sa_2 = ChannelAttention(1024)
        self.sa_3 = ChannelAttention(2048)
...
class ChannelAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        out = avg_out + max_out
        return self.sigmoid(out)*x+x if self.flag else self.sigmoid(out)
