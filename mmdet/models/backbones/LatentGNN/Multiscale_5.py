...
class Multiscale_5(nn.Module):
    def __init__(self):
        super(Multiscale_5, self).__init__()
        ...
        self.weight_hsv_0 = nn.Sequential(
            nn.Conv2d(256, 8, kernel_size=1),
            nn.BatchNorm2d(8),
            nn.ReLU())
        self.weight_hsv_1 = nn.Sequential(
            nn.Conv2d(512, 8, kernel_size=1),
            nn.BatchNorm2d(8),
            nn.ReLU())
        self.weight_hsv_2 = nn.Sequential(
            nn.Conv2d(1024, 8, kernel_size=1),
            nn.BatchNorm2d(8),
            nn.ReLU())
        self.weight_hsv_3 = nn.Sequential(
            nn.Conv2d(2048, 8, kernel_size=1),
            nn.BatchNorm2d(8),
            nn.ReLU())
