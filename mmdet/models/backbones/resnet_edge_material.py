...
class ResNet_Edge_Material(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Edge_Material, self).__init__(**kwargs)
...
if __name__ == "__main__":
    ...
    # print(output.shape)
    from mmdet.models import ResNet_Edge_Material
    import torch

    self = ResNet_Edge_Material(depth=50)
    self.eval()
