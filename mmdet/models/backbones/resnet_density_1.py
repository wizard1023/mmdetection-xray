...
from mmdet.models.backbones.LatentGNN.Density_Guidance_1 import Density_Guidance_1

@MODELS.register_module()
class ResNet_Density_1(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Density_1, self).__init__(**kwargs)
        self.material_guidance = Density_Guidance_1()
