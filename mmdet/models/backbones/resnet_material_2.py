...
from mmdet.models.backbones.LatentGNN.Material_Guidance_2 import Material_Guidance_2

@MODELS.register_module()
class ResNet_Material_2(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Material_2, self).__init__(**kwargs)
        self.material_guidance = Material_Guidance_2()
