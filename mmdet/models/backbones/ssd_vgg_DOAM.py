...
class SSDVGG_DOAM(VGG, BaseModule):
    ...
    def __init__(self,
        ...
        super(SSDVGG_DOAM, self).__init__(
            depth,
        ...
        ##############################################
        self.DOAM = DOAM()
        self.features[0] = nn.Conv2d(4, 64, 3, 1, 1)
        # xavier_init(self.features[0], distribution='uniform')
        ##############################################
