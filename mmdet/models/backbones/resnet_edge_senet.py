...
from mmdet.models.backbones.LatentGNN.Edge_Guidance_senet import Edge_Guidance_senet

@MODELS.register_module()
class ResNet_Edge_senet(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Edge_senet, self).__init__(**kwargs)
        self.edge_guidance = Edge_Guidance_senet()
