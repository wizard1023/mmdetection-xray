...
from mmdet.models.backbones.LatentGNN.Material_Guidance_1 import Material_Guidance_1

@MODELS.register_module()
class ResNet_Material_1(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Material_1, self).__init__(**kwargs)
        self.material_guidance = Material_Guidance_1()
