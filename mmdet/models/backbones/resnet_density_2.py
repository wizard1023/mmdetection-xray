...
from mmdet.models.backbones.LatentGNN.Density_Guidance_2 import Density_Guidance_2

@MODELS.register_module()
class ResNet_Density_2(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Density_2, self).__init__(**kwargs)
        self.material_guidance = Density_Guidance_2()
