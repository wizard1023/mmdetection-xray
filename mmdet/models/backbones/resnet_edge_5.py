...
from mmdet.models.backbones.LatentGNN.Edge_Guidance_4 import Edge_Guidance_4

@MODELS.register_module()
class ResNet_Edge_5(ResNet):
    def __init__(self, **kwargs):
        super(ResNet_Edge_5, self).__init__(**kwargs)
        self.edge_guidance = Edge_Guidance_4()
