...
class DOAM(nn.Module):
    def __init__(self):
        ...
        #     if isinstance(m, nn.Conv2d) and 'Gated' not in n:
        #         kaiming_init(m)
    ...
    def RIA(self,x):
        ...
        # x_pooled_upsample_5 = F.interpolate(x_pooled_5, (300, 300), mode='nearest')
        # x_pooled_upsample_10 = F.interpolate(x_pooled_10, (300, 300), mode='nearest')
        # x_pooled_upsample_15 = F.interpolate(x_pooled_15, (300, 300), mode='nearest')

        x_pooled_upsample_5 = F.interpolate(x_pooled_5, (x.shape[2], x.shape[3]), mode='nearest')
        x_pooled_upsample_10 = F.interpolate(x_pooled_10, (x.shape[2], x.shape[3]), mode='nearest')
        x_pooled_upsample_15 = F.interpolate(x_pooled_15, (x.shape[2], x.shape[3]), mode='nearest')
